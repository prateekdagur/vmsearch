...
@Component({
  selector: 'app-feedback-approval-detail',
  templateUrl: './feedback-approval-detail.component.html',
  styleUrls: ['./feedback-approval-detail.component.scss']
})

export class FeedbackApprovalDetailComponent implements OnInit {
  id:any;
  dataArray:any;
